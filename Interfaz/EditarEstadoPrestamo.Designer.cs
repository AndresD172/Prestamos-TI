...
{
    partial class EditarEstadoPrestamo
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EditarEstadoPrestamo));
            panel1 = new Panel();
            txtDescripcionEstado = new TextBox();
            label7 = new Label();
            label4 = new Label();
            panel2 = new Panel();
            ...
            panel1.Controls.Add(txtDescripcionEstado);
            ...
            // 
            txtDescripcionEstado.Font = new Font("Segoe UI", 12F);
            txtDescripcionEstado.Location = new Point(257, 201);
            txtDescripcionEstado.Name = "txtDescripcionEstado";
            txtDescripcionEstado.Size = new Size(233, 29);
            txtDescripcionEstado.TabIndex = 9;
            // 
            // label7
            // 
            ...
            panel2.Controls.Add(btnEditarEstado);
            ...
            // btnEditarEstado
            // 
            btnEditarEstado.BackColor = Color.FromArgb(242, 225, 255);
            btnEditarEstado.Font = new Font("Baskerville Old Face", 27.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnEditarEstado.Location = new Point(144, 167);
            btnEditarEstado.Name = "btnEditarEstado";
            btnEditarEstado.Size = new Size(393, 63);
            ...
            btnCancelar.Location = new Point(32, 667);
            ...
            Controls.Add(panel1);
            Controls.Add(panel2);
            Name = "EditarEstadoPrestamo";
            Text = "EditarEstadoPrestamo";
        ...
        private TextBox txtDescripcionEstado;
